...
GOLD_CARE_TIPS = [
    "💡 نصيحة اليوم: اشتري دهبك من محل موثوق وعنده سمعة كويسة، "
    "وتأكد إن الفاتورة موضح فيها العيار والوزن والسعر وقت الشراء.",
    "💡 نصيحة اليوم: سعر الدهب بيتغير أكتر من مرة في اليوم — لو "
    "مستني تشتري، تابعي السعر قبل ما تحسمي قرارك.",
    "💡 نصيحة اليوم: لما تبيعي دهب مستعمل، اعرفي إن سعر البيع "
    "(الشراء منك) بيكون أقل من سعر البيع للعميل، والفرق ده بيسمى "
    "\"مصنعية\" أو هامش المحل.",
    "💡 نصيحة اليوم: خلي بالك من الفرق بين عيار 24 (خام) وعيار 21 "
    "وعيار 18 — كل ما العيار يعلى كل ما يبقى أنقى وأغلى.",
    "💡 نصيحة اليوم: لو بتفكري تستثمري في الدهب، السبائك والجنيهات "
    "الدهب أفضل من الحلي عشان معندهاش مصنعية بتتاكل وقت البيع.",
    "💡 نصيحة اليوم: متستعجليش في قرار الشراء وقت ما السعر بيرتفع "
    "فجأة — الأسعار بترجع تستقر غالبًا خلال أيام.",
    "💡 نصيحة اليوم: لو هتستبدلي حلي قديم بجديد، اسألي عن سياسة "
    "الاستبدال في المحل الأول قبل ما تشتري، لأن كل محل له نسبة خصم "
    "مختلفة.",
    "💡 نصيحة اليوم: احتفظي بإيصال أو فاتورة كل قطعة دهب تشتريها — "
    "هتحتاجيها لو حبيتي تبيعي أو تستبدلي في المستقبل.",
    "💡 نصيحة اليوم: تابعي سعر الذهب العالمي (الأونصة) مش بس السعر "
    "المحلي، لأنه المؤشر الأساسي لاتجاه السعر خلال الأيام الجاية.",
